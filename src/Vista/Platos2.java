...
public class Platos2 extends JFrame implements ComponentListener, ActionListener {
	...
	ControladorPlatos2 cp = new ControladorPlatos2();
	...
	public Platos2() {
		...
		JLabel lblTitulo = new JLabel("SEGUNDOS PLATOS");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ControladorVentanas.ocultarSegundosPlatos();
