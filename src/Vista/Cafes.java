...
import Controlador.ControladorCafes;
import Controlador.ControladorPlatos;
import Controlador.ControladorPlatos2;
...
public class Cafes extends JFrame implements ComponentListener, ActionListener {
	...
	Image[] imagenes = cc.sacaImagenes();
	...
	public Cafes() {
		...
		JLabel lblTitulo = new JLabel("CAF\u00C9S E INFUSIONES");
		...
		JRadioButton Boton01 = new JRadioButton(nombreCafe[0]);		
		...
		JRadioButton Boton02 = new JRadioButton(nombreCafe[1]);
		...
		JRadioButton Boton03 = new JRadioButton(nombreCafe[2]);
		...
		JRadioButton Boton04 = new JRadioButton(nombreCafe[3]);
		...
		JRadioButton Boton05 = new JRadioButton(nombreCafe[4]);
		...
		JRadioButton Boton06 = new JRadioButton(nombreCafe[5]);
		...
		JRadioButton Boton07 = new JRadioButton(nombreCafe[6]);
		...
		JRadioButton Boton08 = new JRadioButton(nombreCafe[7]);
		...
		JRadioButton Boton09 = new JRadioButton(nombreCafe[8]);
		...
		JRadioButton Boton10 = new JRadioButton(nombreCafe[9]);
		...
		JRadioButton Boton11 = new JRadioButton(nombreCafe[10]);
		...
		JRadioButton Boton12 = new JRadioButton(nombreCafe[11]);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ControladorVentanas.ocultarCafes();
	...
	public void nombreCafes() throws SQLException{
		
		int num = 0;
		ResultSet consulta = cc.mostrarLosCafes();
		
		while(consulta.next()){
			nombreCafe[num]=consulta.getString("Nombre");
			num++;
		}		
		
	}
	
	public void descripcionCafes() throws SQLException{
