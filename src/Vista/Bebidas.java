...
import Controlador.ControladorBebidas;//aqui importamos el controlador de bebidas
...
public class Bebidas extends JFrame implements ComponentListener, ActionListener {
	...
	ControladorBebidas cb = new ControladorBebidas();
	
	private JPanel contentPane;
	
	Image[] imagenes = cb.sacaImagenes();
	
	int[] clave = new int[12];
	
	String[] nombreBebida = new String[12];
	...
	public Bebidas() {
		...
		JLabel lblTitulo = new JLabel("BEBIDAS");
		...
		JRadioButton Boton01 = new JRadioButton(nombreBebida[0]);		
		...
		JRadioButton Boton02 = new JRadioButton(nombreBebida[1]);
		...
		JRadioButton Boton03 = new JRadioButton(nombreBebida[2]);
		...
		JRadioButton Boton04 = new JRadioButton(nombreBebida[3]);
		...
		JRadioButton Boton05 = new JRadioButton(nombreBebida[4]);
		...
		JRadioButton Boton06 = new JRadioButton(nombreBebida[5]);
		...
		panel_7.add(imagenesLabel[6], BorderLayout.CENTER);
		...
		JRadioButton Boton07 = new JRadioButton(nombreBebida[6]);
		...
		JRadioButton Boton08 = new JRadioButton(nombreBebida[7]);
		...
		JRadioButton Boton09 = new JRadioButton(nombreBebida[8]);
		...
		JRadioButton Boton10 = new JRadioButton(nombreBebida[9]);
		...
		JRadioButton Boton11 = new JRadioButton(nombreBebida[10]);
		...
		JRadioButton Boton12 = new JRadioButton(nombreBebida[11]);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ControladorVentanas.ocultarBebidas();
	...
	public void nombreBebidas() throws SQLException{
		
		int num = 0;
		ResultSet consulta = cb.mostrarLasBebidas();
		
		while(consulta.next()){
			
			
			nombreBebida[num]=consulta.getString("nombre");
			num++;
		}		
		
	}
	
	public void decripcionBebidas() throws SQLException{
