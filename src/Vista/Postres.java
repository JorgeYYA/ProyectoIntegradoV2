...
import Controlador.ControladorPostres;
...
public class Postres extends JFrame implements ComponentListener, ActionListener {
	...
	ControladorPostres cp = new ControladorPostres();
	int tope = 0;
	private JPanel contentPane;
	
	int[] clave = new int[12];
	
	String[] nombrePostre = new String[12];
	...
	public Postres() {
		...
		JLabel lblTitulo = new JLabel("POSTRES");
		...
		JRadioButton Boton01 = new JRadioButton(nombrePostre[0]);		
		...
		JRadioButton Boton02 = new JRadioButton(nombrePostre[1]);
		...
		JRadioButton Boton03 = new JRadioButton(nombrePostre[2]);
		...
		JRadioButton Boton04 = new JRadioButton(nombrePostre[3]);
		...
		JRadioButton Boton05 = new JRadioButton(nombrePostre[4]);
		...
		JRadioButton Boton06 = new JRadioButton(nombrePostre[5]);
		...
		JRadioButton Boton07 = new JRadioButton(nombrePostre[6]);
		...
		JRadioButton Boton08 = new JRadioButton(nombrePostre[7]);
		...
		JRadioButton Boton09 = new JRadioButton(nombrePostre[8]);
		...
		JRadioButton Boton10 = new JRadioButton(nombrePostre[9]);
		...
		JRadioButton Boton11 = new JRadioButton(nombrePostre[10]);
		...
		JRadioButton Boton12 = new JRadioButton(nombrePostre[11]);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ControladorVentanas.ocultarPostres();
	...
	public void nombrePostres() throws SQLException{
		
		int num = 0;
		ResultSet consulta = cp.mostrarLosPostres();
		
		while(consulta.next()){
			nombrePostre[num]=consulta.getString("Nombre");
			num++;
		}		
		
	}
	
	public void descripcionPostres() throws SQLException{
